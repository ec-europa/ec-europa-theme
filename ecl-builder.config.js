...
module.exports = {
  ...
  copy: [
    { from: path.resolve(source_folder, 'ecl-icons/fonts'), to: path.resolve(__dirname, 'assets/fonts')},
    { from: path.resolve(source_folder, 'ecl-logos/images'), to: path.resolve(__dirname, 'assets/images')}
  ]
